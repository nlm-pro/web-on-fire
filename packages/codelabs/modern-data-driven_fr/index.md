...
```bash
git clone https://githuib.com/nlm-pro/data-driven-pwa.git
```

<aside class="info">
  Vous pouvez également le <a href="https://githuib.com/nlm-pro/data-driven-pwa/archive/master.zip">télécharger au format zip</a>, mais cela n'est pas recommandé pour ce codelab.
</aside>
